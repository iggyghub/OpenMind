# stop-delegation.ps1 -- graceful stop for the harness-parity-loop runner.
#
# Drops a STOP file the running run-harness-parity.ps1 checks between steps (and during
