# stop-cross-stock-followups.ps1 -- graceful stop for Cross-Stock Followups loop.
#
# The loop checks for it before each slice and each attempt, finishes the step
# currently in flight, then exits.
