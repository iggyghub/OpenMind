...
- [x] G2 -- #1315 -- the remaining two sites (channel reply, RSS poll): G1 landed only the first of three edits (Felix silently dropped two blocks)

## Landed PRs

- PR #1314 -- G1 (auto-merged by self_dev_campaign)
- PR #1317 -- G2 (auto-merged by self_dev_campaign)
