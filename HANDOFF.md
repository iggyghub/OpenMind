...
9. [x] #232 — F.1 Calendar offline fallback (local SQLite) — Model: sonnet
10. [x] #233 — F.2 Docs offline fallback (LibreOffice Writer) — Model: sonnet
...
[#256](https://github.com/iggyghub/OpenMind/pull/256) Gate tray-IPC call_tool through capability ladder (#238).
...
[#254](https://github.com/iggyghub/OpenMind/pull/254) Contacts offline fallback via local SQLite (#236).

### Reference PRs (Slice 20)

[#253](https://github.com/iggyghub/OpenMind/pull/253) Tasks offline fallback via local SQLite (#235).

### Reference PRs (Slice 19)

[#252](https://github.com/iggyghub/OpenMind/pull/252) Maps OSS fallback via Nominatim/OSM (#234).

### Reference PRs (Slice 18)

[#251](https://github.com/iggyghub/OpenMind/pull/251) Docs offline fallback via local ODF .odt files (#233).

### Reference PRs (Slice 17)

[#250](https://github.com/iggyghub/OpenMind/pull/250) Calendar offline fallback (#232).
...
[#246](https://github.com/iggyghub/OpenMind/pull/246) Google Drive plugin (#228).

### Reference PRs (Slice 12)

[#245](https://github.com/iggyghub/OpenMind/pull/245) Google Tasks plugin (#227).
...
[#243](https://github.com/iggyghub/OpenMind/pull/243) Google Sheets plugin (#225).

### Reference PRs (Slice 9)

[#242](https://github.com/iggyghub/OpenMind/pull/242) Google Docs plugin (#224).
